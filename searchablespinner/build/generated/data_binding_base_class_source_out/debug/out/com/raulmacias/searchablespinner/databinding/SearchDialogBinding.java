...
package com.raulmacias.searchablespinner.databinding;
...
import com.raulmacias.searchablespinner.R;
...
public final class SearchDialogBinding implements ViewBinding {
  ...
  private SearchDialogBinding(@NonNull LinearLayout rootView, @NonNull ListView listView,
  ...
  public static SearchDialogBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new SearchDialogBinding((LinearLayout) rootView, listView, searchView);
    }
